...
from app.api.v1.routes import admin, ai, auth, datasets, ml, monitoring, notifications, projects, rag, reports, sources, spark, users, ws
...
api_router.include_router(ai.router, prefix="/ai", tags=["ai-placeholders"])
